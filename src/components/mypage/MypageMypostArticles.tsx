      ...
      <div className='mx-auto sm:w-8/12 lg:w-6/12 xl:w-[40%]'>
        <div className='overflow-x-auto'>
          ...
          <div className='text-center my-5'>
            <button onClick={() => setIsnewPost(!isNewPost)}>
          ...
          {isNewPost && (
            <div className='p-1 my-4'>
              <input
                className='text-lg w-full mb-4 font-semibold text-gray-700'
                placeholder='HELLO'
                onChange={(e) => {
                  inputTitleHandler(e);
                }}
              ...
              />
              <div className='text-end font-medium my-4'>
                <span
          ...
          <div className='divide-y divide-slate-100 text-sm font-medium'>
            {props.myPostArticles.map((article) => (
              <div key={article.id}>
                {!editState.isEdit ? (
                  <div className='p-1 my-4 hover:bg-gray-100'>
                    <div
                    ...
                    <p className='text-blueGray-500 line-clamp-3 hover:text-clip'>
                      {article.content}
                    </p>
                    <div className='text-end font-medium m-4'>
                      <span
                  ...
                  <div className='p-1 my-4'>
                    ...
                    <div className='flex justify-end'>
                      <div className='text-end font-medium my-4 mx-2'>
                        <span
